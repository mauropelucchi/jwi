...
public class Dictionary extends CachingDictionary {
	 ...
	 * hdfs directory pointed to by the specified path with the configuration of Haddop
	 * 
	 * @param path
	 *            a path pointing to a hdfs directory containing the wordnet data
	 *            files on the hdsf filesystem
	 * @param conf the hadoop Configuration
	 * 
	 * @throws NullPointerException
	 *             if the specified path is <code>null</code>
	 * @since JWI 2.3.3-hadoop
	 * @author Mauro Pelucchi
	 * 
	 */
	public Dictionary(String path, Configuration conf) {
		super(new DataSourceDictionary(new FileProvider(path, conf)));
	}
